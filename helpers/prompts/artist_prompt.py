...
Before providing answers ensure that data is logical and fact checked. Source information only for given author.
...
{{
    ...
    "Total Auction Sold Price (EURO)": int,           // Total price of artist's sold artworks (in EURO).
    "Auction Record Price (EURO)": int,               // Highest known auction price achieved by artist (in EURO).
